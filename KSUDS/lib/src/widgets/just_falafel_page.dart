...
class JustFalafelView extends StatefulWidget {
  static String route = '/JustFalafelView';
  const JustFalafelView({Key? key}) : super(key: key);

  @override
  State<JustFalafelView> createState() => _JustFalafelViewState();
}

class _JustFalafelViewState extends State<JustFalafelView> {
                            ...
                            child: InteractiveViewer(
                                ...
                                child: AspectRatio(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.asset(
                                      "assets/images/Justfalafel.jpeg",
